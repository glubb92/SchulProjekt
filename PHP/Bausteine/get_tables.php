<?php
	...
	function get_attribute_by_art($ID)
	{
	...
	function get_rooms_by_component($bez)
	{
	...
	function get_components_by_room($roomid)
	{
		$Query = "SELECT  
					komp.Komponent_ID,
	...
	function get_component_attributes($ID)
	{
